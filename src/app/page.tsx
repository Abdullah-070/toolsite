  ...
  return (
    <div className="max-w-2xl mx-auto px-5 py-16 prose-article">
      ...
      <p>
        ...
        understand what's actually inside the device they're using or about
        to buy.
      </p>
      <p>
        Everything here is built and maintained by one person, and new tools
        and articles are added regularly as the project grows.
      </p>
    </div>
  );
}
